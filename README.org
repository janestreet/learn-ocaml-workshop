...
* Exercises
  ...
  #+END_SRC
* Lumines and Frogger
  Once you're done with the exercises, you can also implement the block-dropping
  game Lumines, which will run on your desktop.
  
  See the [[file:03-lumines][lumines README]] to get started!

  You can also implement a simplified clone of the classic arcade game Frogger
  in your web browser.
